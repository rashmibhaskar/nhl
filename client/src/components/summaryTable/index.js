...
const SummaryTable = () => {
  ...
  async function fetchTeams() {
    ...
    try {
      const response = await axios.get(
        `https://nhl-node-jm12xat85-rashmibhaskars-projects.vercel.app/api/teams/${season}/${gid}`
      );
  ...
  async function fetchSeasons() {
    const response = await axios.get(`https://nhl-node-jm12xat85-rashmibhaskars-projects.vercel.app/api/seasons`);
